...
using CMsgRequestInventoryRefresh = SteamKit2.GC.CSGO.Internal.CMsgRequestInventoryRefresh;
using CSOEconItem = SteamKit2.GC.CSGO.Internal.CSOEconItem;
...
public class InventoryManager
{
    ...
    public async Task<CEcon_GetInventoryItemsWithDescriptions_Response> GetInventory(uint appId, int count, bool needDescription = false, Language language = Language.English)
    {
        if (count <= 0)
        {
